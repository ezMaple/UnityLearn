...
{
    [SerializeField, Tooltip("Целевой размер объекта при активации")]
    private Vector3 targetScale = new Vector3(2, 2, 2);

    [SerializeField, Tooltip("Скорость изменения масштаба (должна быть больше 0)"), Min(0.01f)]
